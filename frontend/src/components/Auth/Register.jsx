  ...
  return (
    <section className="authPage">
      <div className="container">
        <div className="row">
          <div className="col-lg-5 col-md-8 col-sm-10"> {/* Adjusted column sizes */}
          ...
          <div className="col-lg-7 col-md-8 col-sm-10"> {/* Adjusted column sizes */}
            ...
            <div className="form-group-a">
              ...
              <p className="mt-3 text-center">
                ...
                <span className="line-right"></span></p>
            </form>
          </div>
        </div>
      </div>
